...
// EJECUTO LA FUNCION AJAX.
   ...
   consultaAjax(formData).then(response => {
       //alert(response.respuesta);
       //console.dir(response); MUESTRO EL OBJETO COMPLETO

        if (response.respuesta == 1){
          //SETEO LOS INPUT A VACIO.
          var f = $(this).find('.form-group'); 
          ...
          $(".error-message").text(response.notificaciones);
        }    
   });
  ...
  // FUNCION AJAX: 
  const urlAjax = "contact.php"

  const consultaAjax = async (data) => {
      try {
          ...
          if (response.ok) {
              ...
              return jsonResponse;
              //Para chequear errores utilizar response.text()
          }
